...
<html>
    ...
    <meta name="keyword" content="">
        ...
        <title>ACCOUNTER- Cash Invoice</title>
    ...
    <section id="container" >
      ...
      <?php
        ...
        <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> INVOICE</h3>
                <div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Invoice</h4>
                      <form class="form-horizontal tasi-form" method="post" action="add-invoice-reg.php">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Invoice #</label>
                              <div class="col-sm-6">
                                  <input type="number" class="form-control round-form" name="invoice" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Invoice Date <span>*</span></label>
                              <div class="col-sm-6">
...
<footer class="site-footer">
          <div class="text-center">
              ...
              <a href="profile-women.php" class="go-top">
