                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Estimates</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>ID</th>
                              ...
                              <tbody>
                                  <?php
                                   ...
                                   $sql="select * from add_estimate order by estimate_id";
                                   ...
                                   while($row=mysqli_fetch_array($res,MYSQLI_BOTH))
                                   {
                                      ...
                                      <a href="del-estimate.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                  </td>
                                       </tr>
                                       <?php
                                   }
