    ...
    <section id="container" >
      ...
      <?php
        ...
        <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> GSTR</h3>
                <div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> GSTR</h4>
<form action="gstr-data.php" method="post" class="form-horizontal tasi-form" enctype="multipart/form-data">
	<br>
    <div class="form-group">
    <label class="col-sm-2 col-sm-2 control-label">GST ID <span>*</span></label>
    <div class="col-sm-4">
    <input type="text" class="form-control round-form"  required name="gstid">
  </div>
        </div>
  <div class="form-group">
    <label class="col-sm-2 col-sm-2 control-label">Date <span>*</span></label>
    <div class="col-sm-4">
    <input type="date" class="form-control drop" required name="date">
  </div>
        </div>
  <div class="form-group">
    <label class="col-sm-2 col-sm-2 control-label">Business Name <span>*</span></label>
    <div class="col-sm-4">
    ...
    <div class="col-sm-4 col-md-3">
                        <div class="thumbnail">
                          <img src="images/demo/upload.png" alt="...">
                          
                              <center>
                                  <p>1. Upload your GST File</p>
                                  <input type="file" name="myfile" id="exampleInputFile" size="50" />  
                            <br>
    ...
    <div class="col-sm-4 col-md-3">
                        <div class="thumbnail">
                          <img src="images/demo/refund-2.png" alt="...">
                          
                              <center>
                                  <p>2. Upload your inward transaction</p>
                                  <input type="file" name="inward" id="exampleInputFile" size="50" />
                            <br>
                            <button type="submit" class="btn btn-primary">Upload</button>
                          </center>
                            <br>
    ...
    <div class="col-sm-4 col-md-3">
                        <div class="thumbnail">
                          <img src="images/demo/refund-2.png" alt="...">
                              ...
                              <center>
                                  <p>3. Upload your outward Transaction</p>
                                  <input type="file" name="outward" id="exampleInputFile" size="50" />
                            <br>
                            <button type="submit" class="btn btn-primary">Upload</button>
                          </center>
                            <br>
        ...
        <div class="col-sm-4 col-md-3">
                        <div class="thumbnail">
                          <img src="images/demo/upload.png" alt="...">
                              ...
                              <center>
                                  <p>4. Upload Summary</p>
                                  <input type="file" name="summary" id="exampleInputFile" size="50" />
                            <br>
                            <button type="submit" class="btn btn-primary">Upload</button>
                          </center>
                            <br>
        ...
        <div class="form-group">
        <div class="col-sm-11">
  <center><button type="submit" class="btn btn-success" name="save">Save and Continue</button><br></center>
        </div>
        </div>
	</form>    
