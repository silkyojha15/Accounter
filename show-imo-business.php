...
<html>
    ...
    <meta name="keyword" content="">
        ...
        <title>ACCOUNTER-All Business</title>
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                                  <?php
                                   ...
                                   $sql="select * from new_business order by id";
                                   ...
                                   while($row=mysqli_fetch_array($res,MYSQLI_BOTH))
                                   {
                                      ...
                                      <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                                            <a href="del-imo-business.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                  </td>
                                       </tr>
                                       <?php
                                   }
