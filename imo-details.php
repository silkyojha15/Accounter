...
<div class="container-fluid" id="details">
  ...
  <ul class="pagination">
    ...
    <li class="active"><a href="#">&nbsp;&nbsp;&nbsp; IMO/NGO Details &nbsp;&nbsp;&nbsp; <span class="sr-only">(current)</span></a></li>
    ...
    <form action="imo-details-reg.php" method="post">
	<br>
        <center><b><span style="font-size:25px;">IMO Details</span> </b>
            <p>Ignore, if already filled. Goto <a href="profile-imo.php"><i class="fas fa-user-circle"></i>Profile.</a></p>
        </center>
        
        <hr>
        <div class="form-group">
  <label>Confirm your IMO Type<span>*</span></label>
 <select class="form-control drop" name="imotype" required>
  ...
  <option>Local</option>
   ...
   <div class="form-group">
    <label>IMO/NGO Name: <span>*</span></label>
    <input type="text" class="form-control drop" name="imoname" required>
  </div>
    <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="Text" class="form-control drop" required name="oadd">
    <input type="Text" class="form-control drop" >
    <input type="Text" class="form-control drop" >
  </div>
  <div class="form-group">
    <label >District <span>*</span></label>
    <input type="text" class="form-control" name="distt" required>
  </div>
    <div class="form-group">
    <label > City <span>*</span></label>
    <input type="text" class="form-control drop" required name="city">
  </div>
    <div class="form-group">
  ...
  <button type="submit" class="btn btn-success btn-lg btn-block">Save and Continue</button><br>
    <center><button type="reset" class="btn btn-default btn-primary">Reset</button></center><br>
        
        <center><button type="logout" class="btn btn-default btn-primary"><a href="imo-logout.php" style="color:white;">Log Out</a></button></center>
<br>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <center> <img src="images/demo/bulb.jpg" class="img-responsive img-circle">
                <br>
            <p>
                Keep administrative process simple to avoid mistakes.
            </p>
            <br>
            </center>
        </div>
